...
This repository contains the code for playing checkers using Monte-Carlo-Tree-Search (MCTS). The rules for the game were selected to match those of English Draughts (https://en.wikipedia.org/wiki/English_draughts). 
